...
//                    startActivity(discoverableIntent);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
        if (blueToothAdapter.isDiscovering()) {
            blueToothAdapter.cancelDiscovery();
            Toast.makeText(MainActivity.this,"1 onItemClick blueToothAdapter.isDiscovering()",Toast.LENGTH_LONG).show();
        }
        if (strArr.get(i).getBondState() == BluetoothDevice.BOND_NONE) {
            bond(i);
            Toast.makeText(MainActivity.this,"2 onItemClick BluetoothDevice.BOND_NONE",Toast.LENGTH_LONG).show();
        } else if (strArr.get(i).getBondState() == BluetoothDevice.BOND_BONDED) {
            sendMessage(i);
            Toast.makeText(MainActivity.this,"3 onItemClick sendMessage",Toast.LENGTH_LONG).show();
        }
    }
    ...
    class BluetoothReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                Toast.makeText(MainActivity.this,"找到新设备了",Toast.LENGTH_LONG).show();
...
//https://www.jianshu.com/p/7c92cfc5ee6b
}